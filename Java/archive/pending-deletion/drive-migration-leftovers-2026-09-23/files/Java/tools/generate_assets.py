...
def main():
    ...
    try:
        from extract_sheet_assets import main as extract_sheet_assets

        extract_sheet_assets()
    except Exception as exc:
        print(f"Skipped sheet extraction: {exc}")
    try:
        from generate_npc_assets import main as generate_npc_assets
    ...
    try:
        from generate_monster_assets import main as generate_monster_assets
