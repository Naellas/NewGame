...
TARGETS = (
    Target(Path("Java/assets/player/classes/mage/class_mage_model.png"), 1, (DOWN_LEFT_EYE_CENTER, DOWN_RIGHT_EYE_CENTER)),
    Target(Path("Java/assets/player/classes/mage/class_mage_model_down.png"), 1, (DOWN_LEFT_EYE_CENTER, DOWN_RIGHT_EYE_CENTER)),
    Target(Path("Java/assets/player/classes/mage/class_mage_model_left.png"), 1, (LEFT_PROFILE_EYE_CENTER,)),
    Target(Path("Java/assets/player/classes/mage/class_mage_model_right.png"), 1, (RIGHT_PROFILE_EYE_CENTER,)),
    Target(Path("Java/assets/player/classes/mage/animations/class_mage_model_down_walk_anim.png"), 12, (DOWN_LEFT_EYE_CENTER, DOWN_RIGHT_EYE_CENTER)),
    Target(Path("Java/assets/player/classes/mage/animations/class_mage_model_down_start_walk_anim.png"), 6, (DOWN_LEFT_EYE_CENTER, DOWN_RIGHT_EYE_CENTER)),
    Target(Path("Java/assets/player/classes/mage/animations/class_mage_model_down_stop_walk_anim.png"), 6, (DOWN_LEFT_EYE_CENTER, DOWN_RIGHT_EYE_CENTER)),
    Target(Path("Java/assets/player/classes/mage/animations/class_mage_model_down_idle_anim.png"), 8, (DOWN_LEFT_EYE_CENTER, DOWN_RIGHT_EYE_CENTER)),
    Target(Path("Java/assets/player/classes/mage/animations/class_mage_model_left_walk_anim.png"), 12, (LEFT_PROFILE_EYE_CENTER,)),
    Target(Path("Java/assets/player/classes/mage/animations/class_mage_model_left_start_walk_anim.png"), 6, (LEFT_PROFILE_EYE_CENTER,)),
    Target(Path("Java/assets/player/classes/mage/animations/class_mage_model_left_stop_walk_anim.png"), 6, (LEFT_PROFILE_EYE_CENTER,)),
    Target(Path("Java/assets/player/classes/mage/animations/class_mage_model_left_idle_anim.png"), 8, (LEFT_PROFILE_EYE_CENTER,)),
    Target(Path("Java/assets/player/classes/mage/animations/class_mage_model_right_walk_anim.png"), 12, (RIGHT_PROFILE_EYE_CENTER,)),
    Target(Path("Java/assets/player/classes/mage/animations/class_mage_model_right_start_walk_anim.png"), 6, (RIGHT_PROFILE_EYE_CENTER,)),
    Target(Path("Java/assets/player/classes/mage/animations/class_mage_model_right_stop_walk_anim.png"), 6, (RIGHT_PROFILE_EYE_CENTER,)),
    Target(Path("Java/assets/player/classes/mage/animations/class_mage_model_right_idle_anim.png"), 8, (RIGHT_PROFILE_EYE_CENTER,)),
)
