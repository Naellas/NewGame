...
Riverside Market sells Common and Uncommon assembled gear, Highwall Quartermaster sells Rare and Masterwork gear, and the Crypt Provisioner sells Legendary gear. Generation prompts and tool provenance: `assets/items/atlases/equipment-material-prompts.md`.

Validation from `Java` (compiles the separate test source root):

```powershell
& .\scripts\test.ps1 -Test @('com.alderfall.game.ItemAppearanceTest', 'com.alderfall.game.AssemblyCraftingTest', 'com.alderfall.game.ItemBrowserTest')
```
