...
Runtime PNGs: `assets/environments/props/nature/dungeon_details/dungeon_detail_<name>.png`. Each is a 128×128 RGBA master, bottom-centered with padding. Dungeon placement uses 42-pixel props; overworld dressing uses the existing 42–49-pixel sizing. Existing terrain, entrances, camp shelters, directional perimeter fences, and room layouts provide the structure.
