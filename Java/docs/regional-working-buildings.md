...
All nine assets live in `Java/assets/city/regional/`, with filenames beginning `regional_` as listed in [building-prompts.md](../assets/city/regional/building-prompts.md). They were generated with the built-in imagegen tool and copied unmodified, preserving alpha. Runtime rendering supplies scaling and lighting. The existing regional house sprites remain in use.
