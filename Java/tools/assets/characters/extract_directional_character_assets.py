...
from tools.assets.shared.asset_paths import character_dir
from tools.assets.shared.universal_cutout import CutoutSettings, trim_alpha, universal_cutout
...
SHEETS = [
    (
        ...
        Path("assets/characters/player/base"),
        [
            "player_model",
            "class_knight_model",
            "class_cleric_model",
    ...
    (
        ...
        Path("assets/characters/npcs/townsfolk"),
        [
            "npc_baker_model",
            "npc_bartender_model",
...
from tools.assets.shared.image_ops import component_box
