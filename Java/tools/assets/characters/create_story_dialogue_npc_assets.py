...
from tools.assets.shared.asset_paths import animation_dir, story_npc_dir
...
def main() -> None:
    ...
    out_dir = args.assets_root.resolve() / "characters/npcs/story" / "npcs"
    out_dir.mkdir(parents=True, exist_ok=True)
    sources_dir = args.assets_root.resolve() / "characters/npcs/story" / "sources"
