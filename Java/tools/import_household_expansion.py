...
from universal_cutout import alpha_components, component_box, component_gap

ROOT = Path(__file__).resolve().parents[1]
SOURCE = ROOT / "assets/source/household-expansion"
REVIEW = ROOT.parent / "asset-review/household-expansion"
OUT = ROOT / "assets/interiors/props/household"
...
def main():
    ...
    for sheet,name,box in candidates():
        ...
        if key in REPLACE:
            asset=REPLACE[key]
            existing=list((ROOT/'assets/interiors').rglob(asset+'.png'))
...
<p><a href="comparison.png" style="color:#aee7ae">Game-scale comparison sheet</a> · <a href="manifest.json" style="color:#aee7ae">Crop and decision manifest</a></p>
