    ...
    GameKeyboardController(GamePanel panel) {
        ...
        public void keyPressed(KeyEvent event) {
            ...
            if (code == KeyEvent.VK_F3) {
                ...
                if (panel.state.mode == GameMode.EXPLORE || panel.state.mode == GameMode.BATTLE || panel.state.mode == GameMode.DIALOG) {
        ...
        public void keyReleased(KeyEvent event) {
            if (panel.handleMovementKeyReleased(event.getKeyCode())) {
                panel.repaint();
            }
        }
