...
public final class GameData {
    ...
    public static final Map<String, Quest> QUESTS = Map.ofEntries(
            ...
            mainStoryQuest("ms_camp_defending", "A Camp Worth Defending", "Build Oathstead's defenses, inspect the central oath marker, and repel Morvane the Mercy-Taker's raid.", "Morvane the Mercy-Taker", 1, 210, 180,
                    "maelis", "ms_kingdoms_answer", Quest.ObjectiveKind.DEFEAT, "goblin_camp", 6, "void_knight", "morvane_mercy_taker",
    ...
    public static String rollContextualLoot(String mapKind, char terrain, int dungeonTier, List<MonsterSpec> specs, Random random) {
        ...
        boolean boss = specs.stream().anyMatch(GameData::isBossMonster);
    ...
    private static boolean isBossMonster(MonsterSpec spec) {
    ...
    private static List<String> lootPoolFor(String mapKind, char terrain, int dungeonTier, List<MonsterSpec> specs, boolean boss) {
        if (boss) {
    ...
    private static List<String> bossLootPoolFor(List<MonsterSpec> specs, int dungeonTier) {
