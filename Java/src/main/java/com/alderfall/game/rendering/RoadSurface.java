...
final class RoadSurface {
    ...
    private static final int PAVING_OFFSET = 32;
    private RoadSurface() { }
    ...
    static boolean isMaterial(char material) { return material >= BASE && material < BASE + 32; }
    ...
    static boolean isPaving(char material) { return material >= BASE + PAVING_OFFSET && material < BASE + PAVING_OFFSET + 32; }
