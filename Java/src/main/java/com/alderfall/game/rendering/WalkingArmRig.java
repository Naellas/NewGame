...
final class WalkingArmRig {
    ...
    WalkingArmRig(BufferedImage source, int facing, int top, int body, double center, String name) {
        this.facing = facing;
    ...
    void draw(Graphics2D g, int frame, int which) {
        ...
        drawPart(g, c.parts[2], c.wx, c.wy, p.wristX, p.wristY, p.lowerAngle);
    }
