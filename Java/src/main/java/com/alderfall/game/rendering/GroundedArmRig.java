...
final class GroundedArmRig {
    ...
    GroundedArmRig(BufferedImage source, int facing, int top, int body, double center, String name) {
        ...
        for (int y = 0; y < h; y++) for (int x = 0; x < w; x++) {
            ...
            if ((pixel >>> 24) < 32 || cloak[y][x] || GroundedPartMasks.carryingPose(name)) continue;
