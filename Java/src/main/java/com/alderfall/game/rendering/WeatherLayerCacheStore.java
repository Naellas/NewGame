...
public final class WeatherLayerCacheStore {
    private final Map<String, WeatherLayerCache> caches = new HashMap<>();

    public void drawFaded(Graphics2D g, int width, int height, String key, int zoom, int frame,
    ...
    public void drawStable(Graphics2D g, int width, int height, String key, int zoom, int frame,
    ...
    public void drawPrecipitation(Graphics2D g, int width, int height, String key, int zoom, int frame,
    ...
    public void drawScrollingTile(Graphics2D g, BufferedImage sprite, int width, int height, String key, int zoom,
