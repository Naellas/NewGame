...
frames=Path('Java/assets/player/classes/mage/animations/class_mage_model_cast_anim.frames').read_bytes();assert not frames.startswith(b'\xef\xbb\xbf') and int(frames)==10
