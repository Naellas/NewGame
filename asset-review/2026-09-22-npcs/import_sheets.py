...
for job in jobs:
    ...
    for row in range(rows):
        ...
        output(strip, f'Java/assets/characters/npcs/townsfolk/animations/{stem}_{direction}_{action}_anim.png')
        metadata(f'{columns}\n', f'Java/assets/characters/npcs/townsfolk/animations/{stem}_{direction}_{action}_anim.frames')
        if action == 'walk': output(frames[row*columns], f'Java/assets/characters/npcs/townsfolk/{stem}_{direction}.png')
    if job.get('action', 'walk') == 'walk':
        output(frames[0], f'Java/assets/characters/npcs/townsfolk/{stem}.png')
        ...
        output(portrait, f'Java/assets/characters/npcs/townsfolk/{stem.removesuffix("_model")}.png')
